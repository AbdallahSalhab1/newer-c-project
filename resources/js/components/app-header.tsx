...
// Move nav items inside component to access translations
...
export function AppHeader({ breadcrumbs = [] }: AppHeaderProps) {
    ...
    // Define nav items inside component to access translations
    const mainNavItems: NavItem[] = [
        {
                    ...
                    <div className="lg:hidden">
                        <Sheet>
                            ...
                            <SheetContent side="left" className="flex h-full w-64 flex-col items-stretch justify-between bg-sidebar">
                                <SheetTitle className="sr-only">{t('messages.navigation_menu')}</SheetTitle>
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button variant="ghost" className="size-10 rounded-full p-1">
                                    ...
                                    <span className="sr-only">{t('messages.user_menu')}</span>
                                </Button>
                            </DropdownMenuTrigger>
